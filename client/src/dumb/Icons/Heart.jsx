...
const Heart = ({ fill, width = '40', height = '40', onHover, top, right }) => (
    ...
    <Svg fill={fill} height={height} width={width} onHover={onHover} top={top} right={right} viewBox='8 8 40 40' >

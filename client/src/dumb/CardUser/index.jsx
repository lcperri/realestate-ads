...
export default function UserCard({id,name, lastName, birthday, email, dni, telephone, avatar}){
  ...
  return(
    ...
    <StyledCard className={styles.contened}>
      ...
      <div >
        <img src={avatar ? avatar : "https://cdn.pixabay.com/photo/2020/07/01/12/58/icon-5359553_960_720.png"} className={styles.foto}/>
      </div> 

      <div >
         <h3 className={styles.datos}>Nombre: </h3>
         <h2 className={styles.name}>{capitalize(name)} {capitalize(lastName)}</h2>
      </div>
      ...
      <div >
        <Button className={styles.btns} onClick={handleElim}>Eliminar</Button>            

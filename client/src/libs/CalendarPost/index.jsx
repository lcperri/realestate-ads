   ...
   return (
      <form onSubmit={handleSubmit} id='form'>
         <div className={styles.contactForm}>
            <DivContainer className='calendarPost' contacto={true}>
               <div className="addressWrapper"></div>
               <h1>Agenda una visita:</h1>
               <h2>Horario de visita: de 09 a 14hs - 30min por Visita</h2>
               ...
               <DivRow alignIt='baseline' gap='10px' height='100px' width='100%' justCont='center'>
